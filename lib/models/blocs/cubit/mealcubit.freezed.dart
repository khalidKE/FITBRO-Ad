...
mixin _$MealState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Meal> data) loaded,
    required TResult Function(String message) error,
  }) => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function()? loading,
    TResult? Function(List<Meal> data)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Meal> data) : _data = data;
  ...
  @override
  String toString() {
    return 'MealState.loaded(data: $data)';
  }
...
abstract class _Loaded implements MealState {
  const factory _Loaded(final List<Meal> data) = _$LoadedImpl;
